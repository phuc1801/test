            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="khachhang_id" id="khachhang_id" required>
                    </div>
                    <div class="form-group">
                        <label for="trangthai">Trạng thái</label>
                        <input type="text" class="form-control" name="trangthai" id="trangthai" required>
                    </div>
                    <div class="form-group">
                        <label for="khuyenmai">Khuyến mại</label>
                        <input type="text" class="form-control" name="khuyenmai" id="khuyenmai" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="ngaygiaohang" id="ngaygiaohang" required>
                    </div>
                    <div class="form-group">
